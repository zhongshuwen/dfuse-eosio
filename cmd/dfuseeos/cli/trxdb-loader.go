...
import (
	...
	trxdbLoaderApp "github.com/zhongshuwen/dfuse-eosio/trxdb-loader/app/trxdb-loader"
)
...
func init() {
	launcher.RegisterApp(&launcher.AppDef{
		...
		Logger:      launcher.NewLoggingDef("github.com/zhongshuwen/dfuse-eosio/(trxdb|trxdb-loader).*", nil),
