...
import (
	...
	accounthistApp "github.com/zhongshuwen/dfuse-eosio/accounthist/app/accounthist"
...
func init() {
	...
	launcher.RegisterApp(&launcher.AppDef{
		...
		Logger:      launcher.NewLoggingDef("github.com/zhongshuwen/dfuse-eosio/accounthist/.*", nil),
